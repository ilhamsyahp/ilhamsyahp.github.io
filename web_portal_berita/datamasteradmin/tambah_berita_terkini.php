...
<head>
	...
	<title>Tambah Berita Terkini - TK NEGERI PEMBINA Admin</title>
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light bg-primarys fixed-top">
	  <a class="navbar-brand text-white" href="#">TK NEGERI PEMBINA PANEL ADMIN</a>
	</nav>
		...
		<ul class="list-group">
		  ...
		  <li class="list-group-item">
			  ...
			  <div class="form-group">
			    ...
			    <small id="emailHelp" class="form-text text-muted">kategori prestasi, kegitan dan penting</small>
			  </div>
			  <div class="form-group">
			    <label for="id_kat">Id Kategori</label>
			    <input type="text" class="form-control" id="id_kat" name="id_kat" required autocomplete="off">
			    <small id="emailHelp" class="form-text text-muted">Id kategori berita 1 untuk Prestasi Siswa, 2 untuk Kegiatan dan 3 untuk Berita Penting sesuai kategori berita di atas</small>
			  </div>
			  <div class="form-group">
