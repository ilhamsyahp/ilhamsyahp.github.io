...
<head>
	...
	<title>Edit Berita Terkini - TK NEGERI PEMBINA Admin</title>
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light bg-primarys fixed-top">
	  <a class="navbar-brand text-white" href="#">TK NEGERI PEMBINA/a>
	</nav>
		...
		<ul class="list-group">
		  ...
		  <li class="list-group-item">
			  ...
			  <div class="form-group">
			    ...
			    <small id="emailHelp" class="form-text text-muted">Pilih kategori prestasi, kegiatan, dan penting </small>
			  </div>
			  <div class="form-group">
			    ...
			    <small id="emailHelp" class="form-text text-muted">kategori berita berisi tentang 1 untuk Prestasi Siswa , 2 untuk Kegiatan dan 3 untuk Penting</small>
			  </div>
			  <div class="form-group">
